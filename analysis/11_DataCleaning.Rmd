...
```{r}
raw_data <- read.csv("https://raw.githubusercontent.com/dawobarrel/STAT107_Group25_Repository/refs/heads/main/data/data/nba2024.csv?token=GHSAT0AAAAAADOKOXV3YKF2TENGYUMCZULE2IOTSSQ")
