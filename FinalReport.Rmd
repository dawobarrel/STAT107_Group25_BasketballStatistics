...
As shown our RMSE for our training set is 38.87785 and for our testing set is 40.26133. As these values are very close together, this tells us that our model is not over fitting and is able to generalize to new unseen data.
...
Alejandro: Worked on most of the GitHub repository, and code used for the project.

Darrell: Worked on some of the Github repository, worked on editing report.

Kelvin: Worked on analysis for report, correlation, regression, etc, as well as report setup/structure and abstract.
